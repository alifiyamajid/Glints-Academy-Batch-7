...
export default function ListItemComponent({ product, productBuy }) {
    ...
    return (
        <View style={styles.itemContainer}>
            <Image source={{ uri: product.gambaruri }} style={styles.itemImage} />
            <Text style={styles.itemName}>{product.nama}</Text>
            <Text style={styles.itemPrice}>
                {currencyFormat(parseInt(product.harga))}
            </Text>
